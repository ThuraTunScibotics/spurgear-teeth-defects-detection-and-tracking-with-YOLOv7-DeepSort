...
|        :---:          |               :---:          | 
|          -            |    <img src="https://github.com/ThuraTunScibotics/spurgear-teeth-defects-detection-and-tracking-YOLOv7-DeepSort/blob/main/assets/track_count_1.gif" height="50%" width="50%"> | 
|           -            |                   -          | 
